...
namespace PitneyBowes.Developer.ShippingApi.Model
{
    ...
    {
        /// <summary>
        /// The merchant抯 full name.
        /// </summary>
        virtual public string FullName {get;set;}
        /// <summary>
        /// The merchant抯 email address.
        /// </summary>
        virtual public string Email {get;set;}
        /// <summary>
        /// The date that the merchant抯 PB Postage Account was registered
        /// </summary>
        ...
        /// <summary>
        /// The unique ID used to identify the merchant.  Note: This value is also the merchant抯 Shipper ID.You must specify 
        /// Shipper ID when creating a shipment.
        /// </summary>
        virtual public string PostalReportingNumber {get;set;}
        /// <summary>
        /// The merchant抯 status.
        /// </summary>
        virtual public string MerchantStatus {get;set;}
        /// <summary>
        /// If you change a merchant抯 status from ACTIVE to INACTIVE, you must give a reason for the change. The reason is recorded here. 
        /// For an active merchant, the field is set to null.
        /// </summary>
        virtual public string MerchantStatusReason {get;set;}
        /// <summary>
        /// The date the merchant抯 PB Postage Account was deactivated, if applicable. For an active merchant, the field is set to null.
